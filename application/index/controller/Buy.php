    ...
    public function Index()
    {
        if(input('post.'))
        {
            ...
            if(isset($ret['code']) && $ret['code'] == 0)
            {
                ...
                //可用积分抵扣的总额
                $this->assign('discount_total_price', BuyService::DiscountTotalPrice($ret['data']));
                $this->assign('common_jifen_max_discount_percent', MyC('common_jifen_max_discount_percent'));
