...
{
    return (preg_match('/'.lang('common_regex_nums').'/', $number) == 1) ? true : false;
}
 ...
 * 
 */
function CheckZzs($number)
{
    return (preg_match('/'.lang('common_regex_zzs').'/', $number) == 1) ? true : false;
}
