    ...
    public static function HomeFloorList($params = [])
    {
        ...
        if(!empty($goods_category))
        {
            foreach($goods_category as &$v)
            {
                ...
                $v['goods'] = self::CategoryGoodsList(['where'=>['gci.category_id'=>$category_ids, 'is_home_recommended'=>1], 'm'=>0, 'n'=>10, 'field'=>'g.id,g.title,g.title_color,g.images,g.home_recommended_images,g.original_price,g.price,g.min_price,g.max_price,g.inventory,g.buy_min_number,g.buy_max_number']);
            }
        }
