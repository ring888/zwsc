...
return array(
    ...
    'common_business_type_list'             =>  array(
            ...
            2 => array('id' => 2, 'name' => '签到'),
            3 => array('id' => 3, 'name' => '余额'),
            5 => array('id' => 5, 'name' => '提现'),
        ),
    ...
    // 用户余额 - 操作类型
    'common_balance_log_type_list'             =>  array(
        0 => array('id' => 0, 'name' => '减少', 'checked' => true),
        1 => array('id' => 1, 'name' => '增加'),
    ),
     // 用户提现 - 操作类型
     'common_withdraw_log_type_list'             =>  array(
        0 => array('id' => 0, 'name' => '申请中', 'checked' => true),
    ...
    // 正则
    //正整数
    'common_regex_zzs'                  =>  '^[+]{0,1}(\d+)$',

    //正数,保留两位小数
    'common_regex_nums'                 =>  '^(?!0+(?:\.0+)?$)(?:[1-9]\d*|0)(?:\.\d{1,2})?$',
    // 用户名
